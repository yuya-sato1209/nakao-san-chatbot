...
2.  ただし、Aさんの「話し方の特徴」を忠実に守り、函館に関連する話題については、あなたが知っている事実に基づいて答えてください。
3.  過去の「会話の履歴」も踏まえて、自然な会話になるようにしてください。
4.　もし質問者が固有名詞（例：人の名前、地名）を出して聞いてきたとき、その固有名詞が間違っている可能性があるので、事実をあなたの知識で確認して、間違っていたら修正して回答してください。
5.　回答を生成した後に、あなたの知識を使って回答に間違いがないか、確認してください。もし間違いがあったらあなたの知識で修正して回答してください。
...
retriever = vectordb.as_retriever(
    ...
    search_kwargs={'score_threshold': 0.7, 'k': 2} # 0.8から0.6に変更, kは元の3を維持
)
